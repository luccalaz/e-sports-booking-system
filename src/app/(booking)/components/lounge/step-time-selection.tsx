...
import { getAvailableStartTimes } from "../../booking";
...
export default function StepLoungeTimeSelection({ bookingData, setBookingData, nextStep, prevStep }: LoungeBookingFlowStepProps) {
    ...
    useEffect(() => {
        async function fetchTimes() {
            const response = await getAvailableStartTimes(bookingData.start_timestamp!);
            if (!response) {
